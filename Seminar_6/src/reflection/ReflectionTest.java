 ...
 *  - reflection.ReflectionTest - i.e. it's own class:
 *  - interface_impl.TalkingClock_v1
 *  - interface_impl.TalkingClock_v2
 *  - interface_impl.TalkingClock_v3
 *  - interface_impl.TalkingClock_v4
 *  - interface_impl.TalkingClock_v5
 *  - interface_impl.TalkingClock_v6
 *  - interface_impl.TalkingClock_v7 - this is lambda sample (to be discussed at the next lecture)
 *
 *  - interface_impl.TalkingClock_v5$1TimeEventsListener
 *  - interface_impl.TalkingClock_v6$1
 *  TODO: how we can read the value of the fields that had captured the environment in the classes above?
 *  TODO: pay attention on synthetic fields that capture enclosing generic.variables values for local & anonymous classes...
 */
