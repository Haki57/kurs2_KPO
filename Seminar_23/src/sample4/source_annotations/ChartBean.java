package sample4.source_annotations;

import sample4.source_annotations_tools.PropertyForEditor;
...
public class ChartBean extends JComponent {
    ...
    */
   @PropertyForEditor(editor = "DoubleArrayEditor")
    ...
    */
   @PropertyForEditor(editor = "InverseEditor")
    ...
    */
   @PropertyForEditor(editor = "TitlePositionEditor")
    ...
    * @return  c the color to use for the graph
    */
