...
//            System.out.print(fjp.submit(task).get());
        ...
        // TODO: note that without shutdown() call below the application does not exit (even after main() is finished):
        tpe.shutdown(); //TODO: note that this call is needed
//        fjp.shutdown(); //TODO: note that this call is not needed - since fjp uses daemon threads...
    }
}
