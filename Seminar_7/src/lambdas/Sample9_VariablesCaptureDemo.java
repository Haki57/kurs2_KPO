...
public class Sample9_VariablesCaptureDemo {

    private static int STATIC_VAR = 0;
    private int instanceVar = 1;

    private Sample9_VariablesCaptureDemo(int v){
        this.instanceVar = v;
    }
    ...
    public static void main(String[] args) {
        Sample9_VariablesCaptureDemo instance = new Sample9_VariablesCaptureDemo(1);
...
//        System.out.println("   objectPublicMethods.length = " + Object.class.getMethods().length);
        ...
        // only this reference and local generic.variables are captured (like it happens for inner classes ...):
        try {
