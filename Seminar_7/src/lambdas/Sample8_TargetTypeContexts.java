...
interface MyFunc2 extends MyFunct1 {
    default String whoIsIt(){return "MyFunc2";}
}

public class Sample8_TargetTypeContexts {

    private static MyFunct1 f1 = (f) -> 0;
    private static MyFunct1 f2 = (f) -> {
        System.out.println(f.getClass()); return 1;};
