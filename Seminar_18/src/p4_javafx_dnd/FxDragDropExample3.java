...
public class FxDragDropExample3 extends Application {
	...
	private ListView<Fruit> sourceView = new ListView<>();
	private ListView<Fruit> targetView = new ListView<>();

	// Create the LoggingArea
	private TextArea loggingArea = new TextArea("");

	// Set the Custom Data Format
	private static final DataFormat FRUIT_LIST = new DataFormat("FruitList");
