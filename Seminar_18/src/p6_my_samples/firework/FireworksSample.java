package p6_my_samples.firework;
...
public class FireworksSample extends Application {
    private final CityFireworks cityFireworks = new CityFireworks();

    private void init(Stage primaryStage) {
        Group root = new Group();
        primaryStage.setScene(new Scene(root));
        root.getChildren().add(cityFireworks);
    }
    ...
    public static class CityFireworks extends Pane {
        ...
        public CityFireworks() {
            ...
            background = new ImageView(getClass().getResource("NightMoscow.jpg").toExternalForm());
