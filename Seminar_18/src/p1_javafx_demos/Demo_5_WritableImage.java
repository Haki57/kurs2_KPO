...
public class Demo_5_WritableImage extends Application {
    ...
    private void initImage(AnchorPane root) {
        src = new Image("file:./Seminar_18/src/p1_javafx_demos/Picture_1.jpg");
        ...
        RadioButton mosaicButton = new RadioButton("Mosaic");
