...
public class Demo_6_AnimatedPlot extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        functionChoice.setPromptText("Select function:");
        functionChoice.getItems().addAll(NamedFunction.values());

        functionChoice.valueProperty().addListener((observable, oldFunction, newFunction) -> {
    ...
    public static class Plot {
        ...
        Plot(DoubleUnaryOperator function, double width, double height, double startX, double endX) {
            this.function = function;
            this.startX = startX;
            this.endX = endX;
        ...
        Transition createTransition(Duration cycleDuration, DoubleProperty x, DoubleProperty y) {
