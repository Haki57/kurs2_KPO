...
/**
 * TODO: who can explain what the following program is doing?
 * TODO: draw a diagram to depict thread communications... (sequence diagram | диаграмма последовательности)
 */
    ...
    private Test3_Interrupt(Thread main){
        ...
        t2 = new Thread(
            () -> {
                ...
                //TODO: answer - why t local variable is needed to access getName() method below for printing?
